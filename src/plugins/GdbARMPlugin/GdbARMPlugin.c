/* Automatically generated by
   ...
   from
	GdbARMPlugin * Cog-eem.327 uuid: d8b78ff9-3baf-4217-9810-345304ce963a
 */
static char __buildInfo[] = "GdbARMPlugin * Cog-eem.327 uuid: d8b78ff9-3baf-4217-9810-345304ce963a " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"GdbARMPlugin * Cog-eem.327 (i)"
#else
	"GdbARMPlugin * Cog-eem.327 (e)"
#endif
;
...
primitiveNewCPU(void)
{
	...
	popthenPush(1, positive32BitIntegerFor(((usqIntptr_t) cpu)));
	if (failed()) {
		return null;
	}
	return null;
