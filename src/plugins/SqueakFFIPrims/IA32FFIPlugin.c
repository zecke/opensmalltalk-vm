/* Automatically generated by
   ...
   from
	ThreadedIA32FFIPlugin VMMaker.oscogLLP64-nice.1930 uuid: f15563d6-fbc3-4240-8284-6945a99b5eef
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscogLLP64-nice.1930 uuid: f15563d6-fbc3-4240-8284-6945a99b5eef " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"IA32FFIPlugin VMMaker.oscogLLP64-nice.1930 (i)"
#else
	"IA32FFIPlugin VMMaker.oscogLLP64-nice.1930 (e)"
#endif
;
	...
	if ((((usqInt)atomicType2) >> 1) == (((unsigned int)FFITypeSingleFloat) >> 1)) {
		...
		if (atomicType2 == FFITypeBool) {
			...
			value1 = (byteSize1 == (sizeof(intRet1))
				? intRet1
				: intRet1 & (((((usqIntptr_t)1)) << (byteSize1 * 8)) - 1));
			oop4 = (value1 == 0
				? falseObject()
				: trueObject());
			goto l23;
