/* Automatically generated by
   ...
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscogLLP64-nice.1930 uuid: f15563d6-fbc3-4240-8284-6945a99b5eef
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscogLLP64-nice.1930 uuid: f15563d6-fbc3-4240-8284-6945a99b5eef " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64SysVFFIPlugin VMMaker.oscogLLP64-nice.1930 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscogLLP64-nice.1930 (e)"
#endif
;
	...
	if ((((usqInt)atomicType) >> 1) == (((unsigned int)FFITypeSingleFloat) >> 1)) {
		...
		if (atomicType == FFITypeBool) {
			...
			value = (byteSize == (sizeof(retVal1))
				? retVal1
				: retVal1 & (((((usqIntptr_t)1)) << (byteSize * 8)) - 1));
			oop = (value == 0
				? falseObject()
				: trueObject());
			goto l6;
		...
		if (atomicType <= FFITypeSignedInt) {
			...
			if (atomicType <= ((BytesPerWord == 8
				...
				value = retVal1 & (((((usqIntptr_t)1)) << shift) - 1);
				if (atomicType & 1) {
	...
	if ((((usqInt)atomicType2) >> 1) == (((unsigned int)FFITypeSingleFloat) >> 1)) {
		...
		if (atomicType2 == FFITypeBool) {
			...
			value1 = (byteSize1 == (sizeof(retVal11))
				? retVal11
				: retVal11 & (((((usqIntptr_t)1)) << (byteSize1 * 8)) - 1));
			oop31 = (value1 == 0
				? falseObject()
				: trueObject());
			goto l19;
		...
		if (atomicType2 <= FFITypeSignedInt) {
			...
			if (atomicType2 <= ((BytesPerWord == 8
				...
				value1 = retVal11 & (((((usqIntptr_t)1)) << shift1) - 1);
				if (atomicType2 & 1) {
