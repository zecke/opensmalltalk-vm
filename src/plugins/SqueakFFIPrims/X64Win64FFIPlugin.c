/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64Win64FFIPlugin VMMaker.oscogLLP64-nice.1919 (i)"
#else
	"X64Win64FFIPlugin VMMaker.oscogLLP64-nice.1919 (e)"
#endif
;
...
#  endif /* COGMTVM */
	...
	if ((((usqInt)atomicType) >> 1) == (((unsigned int)FFITypeSingleFloat) >> 1)) {
		...
		intRet = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) (((void *) address))), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
	}
	if (isCalleePopsConvention((calloutState->callFlags))) {
		setsp((calloutState->argVector));
	}
...
#  endif /* COGMTVM */
	...
	if ((((usqInt)atomicType2) >> 1) == (((unsigned int)FFITypeSingleFloat) >> 1)) {
		...
		intRet1 = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) (((void *) address1))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
	...
	if ((((usqInt)atomicType2) >> 1) == (((unsigned int)FFITypeSingleFloat) >> 1)) {
		...
		if (atomicType2 <= FFITypeSignedInt) {
			...
			if (atomicType2 <= ((BytesPerWord == 8
				...
				value1 = intRet1 & (((((usqIntptr_t)1)) << shift1) - 1);
				if (atomicType2 & 1) {
		...
		oop4 = ((((usqInt)atomicType2) >> 1) == (((unsigned int)FFITypeSignedLongLong) >> 1)
			? (atomicType2 & 1
					? signed64BitIntegerFor(intRet1)
					: positive64BitIntegerFor(intRet1))
