/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscogLLP64-nice.1928 uuid: 1fd4baff-608b-4a22-9e51-c11de7b9b4f6
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscogLLP64-nice.1928 uuid: 1fd4baff-608b-4a22-9e51-c11de7b9b4f6
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscogLLP64-nice.1928 uuid: 1fd4baff-608b-4a22-9e51-c11de7b9b4f6 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64Win64FFIPlugin VMMaker.oscogLLP64-nice.1928 (i)"
#else
	"X64Win64FFIPlugin VMMaker.oscogLLP64-nice.1928 (e)"
#endif
;
...
l3:	/* end ffiFloatValueOf: */;
	...
	if (atomicType == FFITypeSingleFloat) {
		...
		if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
			...
			(calloutState->floatRegisterSignature) = ((calloutState->floatRegisterSignature)) + (1U << ((calloutState->integerRegisterIndex)));
...
{
	(self_in_incrementFloatRegisterIndex->floatRegisterSignature) = ((self_in_incrementFloatRegisterIndex->floatRegisterSignature)) + (1U << ((self_in_incrementFloatRegisterIndex->integerRegisterIndex)));
	return ((self_in_incrementFloatRegisterIndex->integerRegisterIndex) = ((self_in_incrementFloatRegisterIndex->integerRegisterIndex)) + 1);
}
