/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscogLLP64-nice.1926 uuid: 0a431195-4bae-0e42-a1f5-5a17d010c24d
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscogLLP64-nice.1926 uuid: 0a431195-4bae-0e42-a1f5-5a17d010c24d
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscogLLP64-nice.1926 uuid: 0a431195-4bae-0e42-a1f5-5a17d010c24d " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64Win64FFIPlugin VMMaker.oscogLLP64-nice.1926 (i)"
#else
	"X64Win64FFIPlugin VMMaker.oscogLLP64-nice.1926 (e)"
#endif
;
...
;
	...
	l8:	/* end ffiCreateIntegralResultOop:ofAtomicType:in: */;
	}
...
;
	...
	l14:	/* end ffiCalloutTo:SpecOnStack:in: */;
		...
		result = result1;
	l15:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
...
;
			storePointerofObjectwithValue(0, retOop11, oop21);
			oop31 = methodReturnValue(retOop11);
		l21:	/* end ffiReturnPointer:ofType:in: */;
		}
		else {
			/* begin ffiReturnStruct:ofType:in: */
...
l24:	/* end ffiCalloutTo:SpecOnStack:in: */;
	/* begin cleanupCalloutState: */
	while (((calloutState1->stringArgIndex)) > 0) {
		free(((calloutState1->stringArgs))[(calloutState1->stringArgIndex = ((calloutState1->stringArgIndex)) - 1)]);
	}
l30:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
