/* Automatically generated by
   ...
   from
	ADPCMCodecPlugin VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c
	ADPCMCodec Sound-mt.56 uuid: 24fb4170-db03-d446-88d6-bc68d542761c
 */
static char __buildInfo[] = "ADPCMCodecPlugin VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c\n\
ADPCMCodec Sound-mt.56 uuid: 24fb4170-db03-d446-88d6-bc68d542761c " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ADPCMCodecPlugin VMMaker.oscogLLP64-nice.1919 (i)"
#else
	"ADPCMCodecPlugin VMMaker.oscogLLP64-nice.1919 (e)"
#endif
;
		...
		if ((i & frameSizeMask) == 1) {
			...
			while(1) {
				...
				if (shift > 0) {
					...
					currentByte = currentByte & (((unsigned int)0xFF) >> (8 - bitPosition));
					predicted = result;
					goto l1;
				}
			}
