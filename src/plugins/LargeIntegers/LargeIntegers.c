/* Automatically generated by
   ...
   from
	LargeIntegersPlugin VMMaker.oscogLLP64-nice.1932 uuid: 642ecc37-5300-3643-8d95-5acb4704c924
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscogLLP64-nice.1932 uuid: 642ecc37-5300-3643-8d95-5acb4704c924 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"LargeIntegers v2.0 VMMaker.oscogLLP64-nice.1932 (i)"
#else
	"LargeIntegers v2.0 VMMaker.oscogLLP64-nice.1932 (e)"
#endif
;
...
anyBitOfLargeIntfromto(sqInt anOop, sqInt start, sqInt stopArg)
{
	...
	firstMask = 0xFFFFFFFFULL << ((start - 1) & 0x1F);
	lastMask = 0xFFFFFFFFU >> (0x1F - ((stop - 1) & 0x1F));
...
cDigitRshiftfromlentolen(sqInt shiftCount, unsigned int *pFrom, sqInt lenFrom, unsigned int *pTo, sqInt lenTo)
{
	...
	carry = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((pFrom[digitShift]))) >> bitShift;
	start = digitShift + 1;
	limit = lenFrom - 1;
