/* Automatically generated by
   ...
   from
	MiscPrimitivePlugin VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c
	Bitmap Graphics-tpr.354 uuid: 31f2b403-7687-49a8-944b-b067f32fb482
	ByteArray Collections-topa.701 uuid: 5ae1b44b-94ef-4657-a76e-387509401f08
	ByteString Collections-topa.701 uuid: 5ae1b44b-94ef-4657-a76e-387509401f08
	SampledSound Sound-mt.56 uuid: 24fb4170-db03-d446-88d6-bc68d542761c
 */
static char __buildInfo[] = "MiscPrimitivePlugin VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c\n\
Bitmap Graphics-tpr.354 uuid: 31f2b403-7687-49a8-944b-b067f32fb482\n\
ByteArray Collections-topa.701 uuid: 5ae1b44b-94ef-4657-a76e-387509401f08\n\
ByteString Collections-topa.701 uuid: 5ae1b44b-94ef-4657-a76e-387509401f08\n\
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"MiscPrimitivePlugin VMMaker.oscogLLP64-nice.1919 (i)"
#else
	"MiscPrimitivePlugin VMMaker.oscogLLP64-nice.1919 (e)"
#endif
;
...
l7:	/* end encodeInt:in:at: */;
	...
	while (k <= size) {
		word = bm[k];
		lowByte = word & 0xFF;
		eqBytes = (((((unsigned int)word) >> 8) & 0xFF) == lowByte)
		 && ((((((unsigned int)word) >> 16) & 0xFF) == lowByte)
		 && (((((unsigned int)word) >> 24) & 0xFF) == lowByte));
		j = k;
		while ((j < size)
		 && (word == (bm[j + 1]))) {
			j += 1;
		...
		if (j > k) {
			...
			l4:	/* end encodeInt:in:at: */;
				/* begin encodeBytesOf:in:at: */
				for (j1 = 0; j1 <= 3; j1 += 1) {
					ba[i + j1] = ((((unsigned int)word) >> ((3 - j1) * 8)) & 0xFF);
				}
				i += 4;
			}
			k = j + 1;
			...
			if (eqBytes) {
				...
				/* begin encodeBytesOf:in:at: */
				for (j5 = 0; j5 <= 3; j5 += 1) {
					ba[(i + 1) + j5] = ((((unsigned int)((1 * 4) + 1)) >> ((3 - j5) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
			...
			l6:	/* end encodeInt:in:at: */;
				for (m = k; m < j; m += 1) {
					/* begin encodeBytesOf:in:at: */
					for (j2 = 0; j2 <= 3; j2 += 1) {
						ba[i + j2] = ((((unsigned int)(bm[m])) >> ((3 - j2) * 8)) & 0xFF);
					}
					i += 4;
				}
				k = j;
