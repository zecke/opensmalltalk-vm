/* Automatically generated by
   ...
   from
	FFTPlugin VMMaker.oscogLLP64-nice.1932 uuid: 642ecc37-5300-3643-8d95-5acb4704c924
 */
static char __buildInfo[] = "FFTPlugin VMMaker.oscogLLP64-nice.1932 uuid: 642ecc37-5300-3643-8d95-5acb4704c924 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FFTPlugin VMMaker.oscogLLP64-nice.1932 (i)"
#else
	"FFTPlugin VMMaker.oscogLLP64-nice.1932 (e)"
#endif
;
static sqInt nu;
...
l4:	/* end checkedFloatPtrOf: */;
	success((((((1ULL << nu) == fftSize) && (((fftSize / 4) + 1) == sinTableSize)) && (fftSize == realDataSize)) && (fftSize == imagDataSize)) && (realDataSize == imagDataSize));
	return (failed()) == 0;
}
