/* Automatically generated by
   ...
   from
	JPEGReaderPlugin VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscogLLP64-nice.1919 uuid: 67128742-82db-1c4a-a5e7-f1f7a5cee80c " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"JPEGReaderPlugin VMMaker.oscogLLP64-nice.1919 (i)"
#else
	"JPEGReaderPlugin VMMaker.oscogLLP64-nice.1919 (e)"
#endif
;
...
jpegDecodeValueFromsize(int *table, sqInt tableSize)
{
	...
	/* Initial bits needed */
	bitsNeeded = ((unsigned int)(table[0])) >> 24;
	...
	l2:	/* end getBits: */;
		...
		bitsNeeded = (((unsigned int)value) >> 24) & 0xFF;
		if (bitsNeeded > MaxBits) {
			return -1;
		}
	}
