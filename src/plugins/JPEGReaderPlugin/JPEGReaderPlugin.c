/* Automatically generated by
   ...
   from
	JPEGReaderPlugin VMMaker.oscogLLP64-nice.1932 uuid: 642ecc37-5300-3643-8d95-5acb4704c924
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscogLLP64-nice.1932 uuid: 642ecc37-5300-3643-8d95-5acb4704c924 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"JPEGReaderPlugin VMMaker.oscogLLP64-nice.1932 (i)"
#else
	"JPEGReaderPlugin VMMaker.oscogLLP64-nice.1932 (e)"
#endif
;
...
decodeBlockIntocomponent(int *anArray, int *aColorComponent)
{
	...
	if (byte != 0) {
		...
		jsBitBuffer = jsBitBuffer & ((1ULL << jsBitCount) - 1);
		bits = value;
	l4:	/* end getBits: */;
		/* begin scaleAndSignExtend:inFieldWidth: */
		if (bits < (1ULL << (byte - 1))) {
			byte = (bits - (1ULL << byte)) + 1;
			goto l1;
		}
		else {
			byte = bits;
